...
const VINAYAGAR_80S_LOOKS = Object.freeze([
  ...
  '1980s Vinayagar procession at blue hour: frame the subject in a joyful chest-up portrait before visarjan, with a flower-covered Vinayagar tableau, dhol players, paper festoons and period street decorations behind them; add background celebrants only when people already exist in the source. Balance a believable on-camera 1980s flash on the subject with cool blue-hour ambient light and warm tungsten street bulbs in the background. The flash direction, facial highlights, garment shadows and nearby flower highlights must agree, while distant people and buildings remain naturally darker. Preserve slight film motion in the procession but keep every source face sharp, youthful and recognisable.',
]);
...
Compose a square, profile-photo-ready head-and-shoulders or chest-up portrait. The face must occupy roughly 45–60% of the frame, with the eyes near the upper third and enough shoulders and festival detail to establish the specific scenario. Do not make the person full-length, three-quarter-length, distant or surrounded by oversized empty background.
