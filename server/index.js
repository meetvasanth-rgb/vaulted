...
const ENHANCER_LOOKS = Object.freeze([
  {
    ...
    direction:`Make a conservative photographic lighting correction. Change only illumination, exposure, white balance, highlight and shadow recovery, local contrast, noise and recoverable sharpness. The source photograph is the geometry reference: preserve the exact face, facial proportions, eyes, eyebrows, nose, lips, teeth, smile, expression, skin texture, hairline, hairstyle, body shape, pose, hand placement, clothing, accessories, camera position, perspective, framing and every meaningful background object. Do not regenerate, beautify, reshape, smooth or reinterpret the person.

First identify the real environment and its existing physical light sources, then make the lighting look professionally captured for that same environment. In a gym or fitness room, preserve the gym, mirrors, machines, benches and weights exactly; create a clean studio-quality sports portrait effect using a soft neutral key aligned with the existing ceiling or window direction, controlled fill on the face and body, subtle separation from the equipment, accurate skin colour and restrained contrast. In a home, follow windows and practical lamps. Outdoors, follow the sun and sky. At night, follow the visible practical or coloured lights. Never paste independent studio lighting onto a scene, replace the room, blur away meaningful context, move objects, change the time of day or restage the photograph.`,
  },
  {
  ...
  },
  {
    ...
    direction:`Apply a conservative photo finish to the existing photograph without redesigning or restaging it. Change only white balance, exposure, dynamic range, noise, compression artefacts, recoverable blur, natural detail and restrained colour finishing. Preserve the exact pixel-space geometry of every person: face shape, facial feature spacing, eyes, eyebrows, nose, lips, teeth, smile, expression, skin texture, hairline, hairstyle, apparent age, body shape, pose and hands. Preserve the camera position, lens perspective, crop, wardrobe, accessories, room layout and every meaningful object. Do not synthesize a cleaner replacement face, beauty-filter the skin, alter the mouth or teeth, slim the body, change the pose, move the subject, add decor, remove equipment or create artificial background blur.

Choose finishing from the actual scenario. For a gym image, keep the gym recognisable and use polished fitness-editorial colour with neutral skin, controlled highlights on equipment, lifted facial shadows and subtle subject separation that follows the existing room lights. For homes, offices, outdoor daylight and night scenes, retain their real light sources and mood. The output must read as the same camera exposure professionally graded and carefully retouched, not a newly generated photograph.`,
  },
  {
...
Render at premium photographic quality with crisp facial detail, realistic skin pores, natural hair strands, fine fabric texture, accurate accessories and clean edges. Apply restrained authentic 1980s colour-film character—subtle organic grain, mild lens softness and gentle print colour—with only minimal physical-print wear away from the face. Do not age the person. Add no text, logos, date stamps or watermarks. The final result must feel like a real photograph from the selected 1980s Indian cinema direction, not an AI effect, a generic family snapshot or the same repeated portrait composition.`,
  },
  {
    ...
    prompt:`Enhance the uploaded photograph into a polished, profile-ready image following the selected transformation family. First inspect the source and identify whether it is a close portrait, half-body or full-body photograph, couple or group; identify the real environment; and identify the direction, softness and colour of its physical light sources. Apply the source-type and environment instructions inside the selected transformation instead of forcing every image into the same portrait or lighting template.

The input photograph is authoritative for identity. Preserve every visible person's exact face and unmistakable identity: face outline, forehead, hairline, eyebrow shape, eye shape and spacing, nose width and profile, cheeks, lips, teeth, smile, jaw, ears, skin tone, exact apparent age, expression, gaze, hairstyle, cultural markers and natural facial fullness. Do not reconstruct the face from a generic beauty ideal. Fresh lighting means flattering exposure and healthy natural skin texture, never making the person younger and never replacing or reshaping the face. Do not add wrinkles, eye bags, grey hair, plastic skin, new makeup, changed teeth, enlarged eyes, a narrowed nose, altered lips, a sharpened jaw or a slimmer face.

For Fix Lighting and Enhance Photo, treat this as a restrained edit of the original pixels: preserve the exact pose, body proportions, hands, clothing, camera viewpoint, lens perspective, crop, scene layout and object placement. Only photographic light and finishing may change. For explicitly illustrative transformations such as Caricature, Mini Me and Cinematic Anime, preserve recognisable identity and source relationships while applying the named medium. Preserve all visible people without adding, merging or omitting anyone. Keep anatomy accurate and head/body proportions natural. Maintain consistent light direction, colour temperature, shadows, perspective and depth across the complete image. Apply exactly the selected transformation as one coherent visual direction, not a collage or a random background swap. No text, logos or watermarks.`,
  },
]);
